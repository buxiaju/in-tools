...
!ifdef MULTIUSER_INSTALLMODEPAGE
  ...
  ${LangFileString} MULTIUSER_TEXT_INSTALLMODE_SUBTITLE "$(^NameDA)(을)를 설치할 사용자를 선택해 주세요."
  ${LangFileString} MULTIUSER_INNERTEXT_INSTALLMODE_TOP "$(^NameDA)(을)를 본인만을 위해 설치할지 이 컴퓨터의 모든 사용자를 위해 설치할지 선택하세요. $(^ClickNext)"
  ${LangFileString} MULTIUSER_INNERTEXT_INSTALLMODE_ALLUSERS "이 컴퓨터를 사용하는 모든 사용자를 위해 설치"
  ${LangFileString} MULTIUSER_INNERTEXT_INSTALLMODE_CURRENTUSER "본인만을 위해 설치"
!endif
